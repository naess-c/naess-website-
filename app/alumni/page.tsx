        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            {alumni.map((person, index) => (
              <ScaleInCard key={index} delay={(index % 8) * 100}>
                <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 p-5 text-center hover:-translate-y-1">
      ...
      <section className="py-20">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
           ...
           <a href="https://forms.gle/poeUfn4zWdyXPpgw5"
            target="_blank"
